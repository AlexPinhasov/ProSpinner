...
extension UIView
{
    func addViewConstraintsForTopLevelView(view: UIView)
    {
...
open class JSSAlertView: UIViewController {
	...
	open override func viewDidLayoutSubviews() {
		...
		if !noButtons {
			...
			// set button fonts
			if buttonLabel != nil {
				buttonLabel.font = UIFont(name: buttonFont, size: 17)
			}
			if cancelButtonLabel != nil {
	...
	public func show(_ viewController: UIViewController,
	                           ...
	                           delay: Double? = nil,
	                           timeLeft: UInt? = nil,
	                           loadingSpinner:Bool? = false) -> JSSAlertViewResponder {
        ...
        if loadingSpinner == true
        {
            ...
            self.view.addViewConstraintsForTopLevelView(view: indicator)
